...
return [
    ...
    'smsSendSuccess' => '验证码发送成功',
    'smsSendError'   => '验证码发送失败',
    'login_token_error'  => '访问已失效,请刷新页面后重试',
    'login_verify_error' => '验证码不正确',
    'login_input_code'   => '请输入验证码',
    'login_input_nickName' => '请输入昵称',
    'login_phone_error'  => '手机号不正确,请重新输入',
    'login_phone_empty'  => '手机号不能为空',
    'login_password_empty' => '密码不能为空',
    'login_password_length_min' => '密码格式不正确,密码长度过小',
    'login_password_length_max' => '密码格式不正确,密码长度过大',
    'login_error'            => '登录失败',
    'login_success'          => '登录成功',
    'register_fail'          =>  '注册失败',
